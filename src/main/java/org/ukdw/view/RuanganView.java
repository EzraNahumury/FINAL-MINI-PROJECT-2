...
public class RuanganView implements Initializable {
    ...
    public void handleAddAction(ActionEvent actionEvent) throws SQLException {
        ...
        if (ruanganManager.adaDiGedung(namaRuangan,idGedung)){
            showAlert("Gagal","Ruangan duplikat");
            return;
        }
